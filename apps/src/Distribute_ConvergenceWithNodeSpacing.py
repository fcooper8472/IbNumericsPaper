...
executable = os.path.join(chaste_build_dir, 'projects/IbNumericsPaper/apps', 'Exe_ConvergenceWithNodeSpacing')
...
pdf_name = os.path.join(path_to_output, 'ConvergenceWithNodeSpacing')
...
def plot_results():
    ...
    plt.plot(node_spacing, log_error, marker='o',
             linewidth=0,
             markerfacecolor=mycol_lb,
             markeredgecolor=mycol_or,
             markersize=4.0,
